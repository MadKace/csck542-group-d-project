"""API service providing the main interface for ORM-based database access."""
...
class ORMAPIService:
    """Facade providing a single entry point for ORM-based data access.
    ...
    _instance: "ORMAPIService | None" = None

    def __new__(cls) -> "ORMAPIService":
    ...
    def _initialise(self) -> None:
        ...
        self._factory = ORMRepositoryFactory(get_session())
